...
```{r}
sum.data$Δspp.richness = spp_count-lead(spp_count)

sum.data$Δweb.modularity = time_mods-lead(time_mods)

sum.data$ΔTavg = climate_dat$Calculated_Average_Temp-lead(climate_dat$Calculated_Average_Temp)

sum.data$ΔTmax = climate_dat$CCSM_Max_Temp_C-lead(climate_dat$CCSM_Max_Temp_C)

sum.data$ΔTmax_SD = climate_dat$CCSM_Max_Temp_SD-lead(climate_dat$CCSM_Max_Temp_SD)

sum.data$ΔTmin = climate_dat$CCSM_Min_Temp_C-lead(climate_dat$CCSM_Min_Temp_C)

sum.data$ΔTmin_SD = climate_dat$CCSM_Min_Temp_SD-lead(climate_dat$CCSM_Min_Temp_SD)

sum.data$ΔPr = climate_dat$CCSM_Precip_mm-lead(climate_dat$CCSM_Precip_mm)

sum.data$ΔPrCv = climate_dat$CCSM_Precip_CV-lead(climate_dat$CCSM_Precip_CV)

sum.data$ΔConnectance = sum.data$connectance-lead(sum.data$connectance)

sum.data$ΔNOS = sum.data$NOS-lead(sum.data$NOS)
...
#### 11.1. Fig. 3 and 5 - 3 rows, 2 columns - Raw Values Over Time
```{r, fig.height=10, fig.width=12}

plot_grid(mod.test, spcraw.plot, nos.null.plot, connectance.null.plot, temp.plot_2, precip.plot_2, nrow=3, ncol=2, labels = "AUTO", vjust = 1.3, hjust = -0.2, align="v")
...
plot(sum.data$ΔTavg, sum.data$Δweb.modularity, type="p", col="black", pch=16, xlab = "Δ Mean Temperature (°C)", ylab = "Δ Modularity")

plot(sum.data$ΔPr, sum.data$Δweb.modularity, type="p", col="black", pch=16, xlab = "Δ Precipitation (mm)", ylab = "Δ Modularity")

plot(sum.data$ΔTmax, sum.data$Δweb.modularity, type="p", col="black", pch=16, xlab = "Δ Max Temperature (°C)", ylab = "Δ Modularity")

plot(sum.data$ΔTmax_SD, sum.data$Δweb.modularity, type="p", col="black", pch=16, xlab = "Δ Standard Deviation of Max Temperature (°C)", ylab = "Δ Modularity")

plot(sum.data$ΔTmin, sum.data$Δweb.modularity, type="p", col="black", pch=16, xlab = "Δ Min Temperature (°C)", ylab = "Δ Modularity")

plot(sum.data$ΔTmin_SD, sum.data$Δweb.modularity, type="p", col="black", pch=16, xlab = "Δ Standard Deviation of Min Temperature (°C)", ylab = "Δ Modularity")

plot(sum.data$Δspp.richness, sum.data$Δweb.modularity, type="p", col="black", pch=16, xlab = "Δ Species Richness", ylab = "Δ Modularity")

```


#### 11.3. Raw Data: Modularity vs Connectance Correlations and Plots
```{r}
par(mfrow=c(1,1), pty = "s")
...
plot(time.dat.change$TM.change, time.dat.change$connectance.change, type="p", col="black", pch=16, xlab = "Δ Connectance", ylab = "Δ Modularity")

cor.test(time.dat.change$TM.change, time.dat.change$connectance.change,method="spearman")

```
When looking at the relationship between Δ Mod and Δ Conn, there is a negative correlation but not significant.


#### 11.4. Raw Data: Climate vs Connectance Correlations and Plots
```{r, fig.height=10, fig.width=10}
...
plot(sum.data$ΔTavg, sum.data$ΔConnectance, type="p", col="black", pch=16, xlab = "Δ Mean Temperature (°C)", ylab = "Δ Connectance")

plot(sum.data$ΔPr, sum.data$ΔConnectance, type="p", col="black", pch=16, xlab = "Δ Precipitation (mm)", ylab = "Δ Connectance")

plot(sum.data$ΔTmax, sum.data$ΔConnectance, type="p", col="black", pch=16, xlab = "Δ Max Temperature (°C)", ylab = "Δ Connectance")

plot(sum.data$ΔTmax_SD, sum.data$ΔConnectance, type="p", col="black", pch=16, xlab = "Δ Standard Deviation of Max Temperature (°C)", ylab = "Δ Connectance")

plot(sum.data$ΔTmin, sum.data$ΔConnectance, type="p", col="black", pch=16, xlab = "Δ Min Temperature (°C)", ylab = "Δ Connectance")

plot(sum.data$ΔTmin_SD, sum.data$ΔConnectance, type="p", col="black", pch=16, xlab = "Δ Standard Deviation of Min Temperature (°C)", ylab = "Δ Connectance")

plot(sum.data$Δspp.richness, sum.data$ΔConnectance, type="p", col="black", pch=16, xlab = "Δ Species Richness", ylab = "Δ Connectance")



cor.test(sum.data$ΔTavg, sum.data$ΔConnectance,method="spearman")
cor.test(sum.data$ΔPr, sum.data$ΔConnectance,method="spearman")
cor.test(sum.data$ΔTmax, sum.data$ΔConnectance,method="spearman")
cor.test(sum.data$ΔTmax_SD, sum.data$Δconnectance,method="spearman")
cor.test(sum.data$ΔTmin, sum.data$ΔConnectance,method="spearman")
cor.test(sum.data$ΔTmin_SD, sum.data$ΔConnectance,method="spearman")
cor.test(sum.data$ΔTmax_SD, sum.data$ΔConnectance,method="spearman")
cor.test(sum.data$Δspp.richness, sum.data$ΔConnectance,method="spearman")

```


#### 11.5. Raw Data: Climate vs NOS Correlations and Plots
...
plot(sum.data$ΔTavg, sum.data$ΔNOS, type="p", col="black", pch=16, xlab = "Δ Mean Temperature (°C)", ylab = "Δ NOS")

plot(sum.data$ΔPr, sum.data$ΔNOS, type="p", col="black", pch=16, xlab = "Δ Precipitation (mm)", ylab = "Δ NOS")

plot(sum.data$ΔTmax, sum.data$ΔNOS, type="p", col="black", pch=16, xlab = "Δ Max Temperature (°C)", ylab = "Δ NOS")

plot(sum.data$ΔTmax_SD, sum.data$ΔNOS, type="p", col="black", pch=16, xlab = "Δ Standard Deviation of Max Temperature (°C)", ylab = "Δ NOS")

plot(sum.data$ΔTmin, sum.data$ΔNOS, type="p", col="black", pch=16, xlab = "Δ Min Temperature (°C)", ylab = "Δ NOS")

plot(sum.data$ΔTmin_SD, sum.data$ΔNOS, type="p", col="black", pch=16, xlab = "Δ Standard Deviation of Min Temperature (°C)", ylab = "Δ NOS")

plot(sum.data$Δspp.richness, sum.data$ΔNOS, type="p", col="black", pch=16, xlab = "Δ Species Richness", ylab = "Δ NOS")



cor.test(sum.data$ΔTavg, sum.data$ΔNOS,method="spearman")
cor.test(sum.data$ΔPr, sum.data$ΔNOS,method="spearman")
cor.test(sum.data$ΔTmax, sum.data$ΔNOS,method="spearman")
cor.test(sum.data$ΔTmax_SD, sum.data$ΔNOS,method="spearman")
cor.test(sum.data$ΔTmin, sum.data$ΔNOS,method="spearman")
cor.test(sum.data$ΔTmin_SD, sum.data$ΔNOS,method="spearman")
cor.test(sum.data$ΔTmax_SD, sum.data$ΔNOS,method="spearman")
cor.test(sum.data$Δspp.richness, sum.data$ΔNOS,method="spearman")
...
p2=ggplot(time.dat.change, aes(x=Pr.change, y=web.modularity))+
  geom_point(size=2) +
  theme_bw() +
  theme(axis.title=element_text(size=9)) +
  ylab("Δ Modularity") +
...
p3=ggplot(time.dat.change, aes(x=Tmax.change, y=web.modularity))+
  geom_point(size=2) +
  theme_bw() +
  theme(axis.title=element_text(size=9)) +
  ylab("Δ Modularity") +
...
p4=ggplot(time.dat.change, aes(x=Tmax_SD.change, y=web.modularity))+
  geom_point(size=2) +
  theme_bw() +
  theme(axis.title=element_text(size=9)) +
  ylab("Δ Modularity") +
...
p5=ggplot(time.dat.change, aes(x=Tmin.change, y=web.modularity))+
  geom_point(size=2) +
  theme_bw() +
  theme(axis.title=element_text(size=9)) +
  ylab("Δ Modularity") +
...
p6=ggplot(time.dat.change, aes(x=Tmin_SD.change, y=web.modularity))+
  geom_point(size=2) +
  theme_bw() +
  theme(axis.title=element_text(size=9)) +
  ylab("Δ Modularity") +
...
p7=ggplot(time.dat.change, aes(x=SpC.change, y=web.modularity))+
  geom_point(size=2) +
  theme_bw() +
  ylab("Δ Modularity") +
...
p7=ggplot(time.dat.change, aes(x=SpC.change, y=TM.change))+
  geom_point(size=2) +
  theme_bw() +
  ylab("Δ Modularity") +
  xlab("Δ Species Richness")

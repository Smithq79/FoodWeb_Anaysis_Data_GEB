...
plot(time_nets[[1]], vertex.label.cex=0.4, vertex.label.color="red", vertex.color=V(time_nets[[1]])$color,  main=colnames(interval_dat[1]))

plot(time_nets[[9]], vertex.label="", vertex.color=V(time_nets[[9]])$color,  main=colnames(interval_dat[9]))

plot(time_nets[[16]], vertex.label="", vertex.color=V(time_nets[[16]])$color, main=colnames(interval_dat[16]))

plot(time_nets[[16]], vertex.label.cex=0.4, vertex.label.color="black", vertex.color=V(time_nets[[16]])$color,  main="Pleistocene (20752-20988 ybp)")
plot(time_nets[[9]], vertex.label="", vertex.color=V(time_nets[[9]])$color,  main="Holocene (11339-12656 ybp)")
plot(time_nets[[1]], vertex.label="", vertex.color=V(time_nets[[1]])$color,  main="Modern Holocene (0-1128 ybp)")

plot(time_nets[[13]], vertex.label="", vertex.color=V(time_nets[[13]])$color,  main="Pleistocene (17216-18159 ybp)")
plot(time_nets[[10]], vertex.label.cex=0.4, vertex.label.color="black", vertex.color=V(time_nets[[10]])$color,  main="Pleistocene (12986-14623 ybp)")
```
...
### 3.2.2 Plot the networks with modules identified
...
for(i in 1:length(time_nets)){
  plot(comms[[i]], time_nets[[i]], vertex.label="",  main=colnames(interval_dat)[i], edge.color=gray(0.5), mark.col=gray(0.8, alpha=0.5), mark.border="black", edge.arrow.size=0.5, edge.arrow.width=0.7, col=V(time_nets[[i]])$color)
}
```
...
mod.test_2=ggplot(data=sum.data, aes(x=-interval.mid)) +
  #geom_vline(xintercept = interval.start, color="gray") +
  geom_rect(xmin=interval.start, xmax=interval.end, ymin=-0.5, ymax=Inf, fill="gray", alpha=0.5) +
  geom_rect(xmin=interval.start[9], xmax=interval.end[9], ymin=-0.5, ymax=Inf, fill="#ffeda0", alpha=0.5) +
    geom_rect(xmin=interval.start[11], xmax=interval.end[11], ymin=-0.5, ymax=Inf, fill="#ffc675", alpha=0.5) +
...
nos.test_2=ggplot(data=sum.data, aes(x=-interval.mid)) +
  #geom_vline(xintercept = interval.start, color="gray") +
  geom_rect(xmin=interval.start, xmax=interval.end, ymin=-0.5, ymax=Inf, fill="gray", alpha=0.5) +
  geom_rect(xmin=interval.start[9], xmax=interval.end[9], ymin=-0.5, ymax=Inf, fill="#ffeda0", alpha=0.5) +
    geom_rect(xmin=interval.start[11], xmax=interval.end[11], ymin=-0.5, ymax=Inf, fill="#ffc675", alpha=0.5) +
...
nos.null.plot_2 = ggplot(data=sum.data, aes(x=-interval.mid)) +
  geom_rect(xmin=interval.start, xmax=interval.end, ymin=-0.25, ymax=Inf, fill="gray", alpha=0.5) +
 geom_rect(xmin=interval.start[9], xmax=interval.end[9], ymin=-0.25, ymax=Inf, fill="#ffeda0", alpha=0.5) +
    geom_rect(xmin=interval.start[11], xmax=interval.end[11], ymin=-0.5, ymax=Inf, fill="#ffc675", alpha=0.5) +
  geom_vline(xintercept = 950.0, color = "white", size=1.5) +
...
connectance.null.plot_2 = ggplot(data=sum.data, aes(x=-interval.mid)) +
  geom_rect(xmin=interval.start, xmax=interval.end, ymin=-0.25, ymax=Inf, fill="gray", alpha=0.5) +
 geom_rect(xmin=interval.start[9], xmax=interval.end[9], ymin=-0.25, ymax=Inf, fill="#ffeda0", alpha=0.5) +
    geom_rect(xmin=interval.start[11], xmax=interval.end[11], ymin=-0.5, ymax=Inf, fill="#ffc675", alpha=0.5) +
  geom_vline(xintercept = 950.0, color = "white", size=1.5) +
...
temp.plot_2 = ggplot(data=time.dat, aes(x=-interval.mid)) +
  geom_rect(xmin=interval.start, xmax=interval.end, ymin=-0.3, ymax=Inf, fill="gray", alpha=0.5) +
  geom_rect(xmin=interval.start[9], xmax=interval.end[9], ymin=-0.3, ymax=Inf, fill="#ffeda0", alpha=0.5) +
      geom_rect(xmin=interval.start[11], xmax=interval.end[11], ymin=-0.3, ymax=Inf, fill="#ffc675", alpha=0.5) +
  geom_vline(xintercept = 950.0, color = "white", size=1.5) +
...
precip.plot_2 = ggplot(data=time.dat, aes(x=-interval.mid)) +
  geom_rect(xmin=interval.start, xmax=interval.end, ymin=-60, ymax=Inf, fill="gray", alpha=0.5) +
  geom_rect(xmin=interval.start[9], xmax=interval.end[9], ymin=-60, ymax=Inf, fill="#ffeda0", alpha=0.5) +
      geom_rect(xmin=interval.start[11], xmax=interval.end[11], ymin=-60, ymax=Inf, fill="#ffc675", alpha=0.5) +
  geom_vline(xintercept = 950.0, color = "white", size=1.5) +
...
spcraw.plot_2 = ggplot(data=time.dat, aes(x=-interval.mid)) +
  geom_rect(xmin=interval.start, xmax=interval.end, ymin=-25, ymax=Inf, fill="gray", alpha=0.5) +
  geom_rect(xmin=interval.start[9], xmax=interval.end[9], ymin=-25, ymax=Inf, fill="#ffeda0", alpha=0.5) +
      geom_rect(xmin=interval.start[11], xmax=interval.end[11], ymin=-25, ymax=Inf, fill="#ffc675", alpha=0.5) +
  geom_vline(xintercept = 950.0, color = "white", size=1.5) +
...
```{r}
plot(time.dat.change$SpC.change, time.dat.change$connectance.change, type="p", col="black", pch=16, xlab = "Δ Species Richness", ylab = "Δ Modularity")
```
...
#       sheetName = "Climate v Mod", append = FALSE)
```
...
Export as an excel file
```{r}
#write.xlsx(spearman_summaries, file = "Supplemental Data/Supplemental_Analyses.xlsx",
      #sheetName = "Partial Correlations", append = FALSE)
```
...
## 11. Testing Reviewer Suggestions

### Collapsing Figures:

#### 11.1. Plotting Variables

Fig. 3 and 5 (3 rows, 2 columns) - Raw Values Over Time
```{r, fig.height=10, fig.width=12}

plot_grid(mod.test, spcraw.plot, nos.null.plot, temp.plot, connectance.null.plot_2, precip.plot_2, nrow=3, ncol=2, labels = "AUTO", vjust = 1.3, hjust = -0.2, align="v")
...
#### 11.2. Modularity vs Connectance Correlations

Raw Data: Modularity vs Connectance Correlations and Plots
```{r}
par(mfrow=c(1,1), pty = "s")

plot(sum.data$web.modularity, sum.data$connectance, type="p", col="black", pch=16, xlab = "connectance", ylab = "Modularity")

cor.test(sum.data$web.modularity, sum.data$connectance,method="spearman")
```

1st Difference Data: Δ Modularity vs Δ Connectance Correlations and Plots
```{r}
par(mfrow=c(1,1), pty = "s")

plot(sum.data$web.modularity.change, sum.data$connectance.change, type="p", col="black", pch=16, xlab = "Δ Connectance", ylab = "Δ Modularity")

cor.test(sum.data$web.modularity.change, sum.data$Connectance.change,method="spearman")

```
When looking at the relationship between Δ Mod and Δ Conn, there is a negative correlation but not significant.


#### 11.3. Climate vs Connectance Correlations

Raw Data: Climate vs Connectance Correlations and Plots
```{r, fig.height=10, fig.width=10}

par(mfrow=c(3,3), mar=c(5,5,5,5), pty = "s")

plot(sum.data$Tavg, sum.data$connectance, type="p", col="black", pch=16, xlab = "Mean Temperature (°C)", ylab = "Connectance")

plot(sum.data$Pr, sum.data$connectance, type="p", col="black", pch=16, xlab = "Precipitation (mm)", ylab = "Connectance")

plot(sum.data$Tmax, sum.data$connectance, type="p", col="black", pch=16, xlab = "Max Temperature (°C)", ylab = "Connectance")

plot(sum.data$Tmax_SD, sum.data$connectance, type="p", col="black", pch=16, xlab = "Standard Deviation of Max Temperature (°C)", ylab = "Connectance")

plot(sum.data$Tmin, sum.data$connectance, type="p", col="black", pch=16, xlab = "Min Temperature (°C)", ylab = "Connectance")

plot(sum.data$Tmin_SD, sum.data$connectance, type="p", col="black", pch=16, xlab = "Standard Deviation of Min Temperature (°C)", ylab = "Connectance")

plot(sum.data$spp.richness, sum.data$connectance, type="p", col="black", pch=16, xlab = "Species Richness", ylab = "Connectance")

# cor.test(sum.data$Tavg, sum.data$connectance,method="spearman");
# cor.test(sum.data$Pr, sum.data$connectance,method="spearman");
# cor.test(sum.data$Tmax, sum.data$connectance,method="spearman");
# cor.test(sum.data$Tmax_SD, sum.data$connectance,method="spearman");
# cor.test(sum.data$Tmin, sum.data$connectance,method="spearman");
# cor.test(sum.data$Tmin_SD, sum.data$connectance,method="spearman");
# cor.test(sum.data$Tmax_SD, sum.data$connectance,method="spearman");
# cor.test(sum.data$spp.richness, sum.data$connectance,method="spearman");
```

Run spearman correlations and arrange results into table.
```{r}
key_stats <- c("Tavg", "Pr", "Tmax", "Tmax_SD", "Tmin", "Tmin_SD", "spp.richness");
spearman_summaries <- data.frame(stat=as.character(key_stats),rho=as.numeric(rep(0,length(key_stats))),pvalue=as.numeric(rep(0,length(key_stats))));
for (ks in 1:length(key_stats)) {
  spearman_test <- cor.test(sum.data[,match(key_stats[ks],colnames(sum.data))],sum.data$connectance,method="spearman");
spearman_summaries$rho[ks] <- round(spearman_test$estimate,3);
spearman_summaries$pvalue[ks] <- spearman_test$p.value;
if (spearman_summaries$pvalue[ks]>10^-2)  {
  spearman_summaries$pvalue[ks] <- round(spearman_summaries$pvalue[ks],3)
...
Export as an excel file that adds to the file
```{r}
# write.xlsx(spearman_summaries, file = "Supplemental Data/Spearman_Correlations.xlsx",
#       sheetName = "Climate v Con", append = TRUE)
```

#### 11.4. Climate vs NOS Correlations
...
spearman_summaries <- data.frame(stat=as.character(key_stats),rho=as.numeric(rep(0,length(key_stats))),pvalue=as.numeric(rep(0,length(key_stats))));
for (ks in 1:length(key_stats)) {
  spearman_test <- cor.test(sum.data[,match(key_stats[ks],colnames(sum.data))],sum.data$NOS,method="spearman");
spearman_summaries$rho[ks] <- round(spearman_test$estimate,3);
spearman_summaries$pvalue[ks] <- spearman_test$p.value;
if (spearman_summaries$pvalue[ks]>10^-2)  {
  spearman_summaries$pvalue[ks] <- round(spearman_summaries$pvalue[ks],3)
...
```{r}
# write.xlsx(spearman_summaries, file = "Supplemental Data/Spearman_Correlations.xlsx",
#       sheetName = "Climate v NOS", append = TRUE)
```

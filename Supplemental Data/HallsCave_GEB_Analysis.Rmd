...
#plei_trophic_mods=read.csv("New_Data/Plei_trophic_mods_9-1-2023.csv")

#holo_trophic_mods=read.csv("New_Data/Holo_trophic_mods_9-13-2023.csv")

#mods_per_bin=read.csv("New_Data/mods_per_bin_4-13-2023.csv")
```
...
plot_grid(mod.nos.plot, connectance.plot, temp.plot, precip.plot, spcraw.plot, nrow=5, align="v")
```
...
### 9.1. Extra: Spearman Partial Correlations
...
```
## Supplemental Materials: Temporal autocorrelation plots
